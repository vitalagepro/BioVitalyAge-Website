...
function setupCarousel(containerSelector, prevButtonSelector, nextButtonSelector) {
    const carouselContainer = document.querySelector(containerSelector);
    const scrollContainer = carouselContainer.querySelector(".card-carousel-container");

    const cardWidth = scrollContainer.querySelector(".card-carousel").offsetWidth + 15; // Larghezza card + gap
